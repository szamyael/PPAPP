...
import { Star, Search, BookOpen, DollarSign, Loader2 } from "lucide-react";
...
export function FindTutors() {
  ...
  }, [tutors, searchTerm, subjectFilter]);

  // Handle search input with debounce
  useEffect(() => {
    const timer = setTimeout(() => {
      // Search term is already in state, filtering happens in useMemo
    }, 300);
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <Card>
            <CardContent className="py-12 text-center">
              <p className="text-red-600">Error loading tutors. Please try again later.</p>
            </CardContent>
          </Card>
        </div>
      </div>
